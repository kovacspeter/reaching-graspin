...
register(
    id='Grasper3d-v0',
    entry_point='gym.envs.mujoco:Grasper3DEnv',
    max_episode_steps=100
)

register(
    id='Grasper3d_3obj-v0',
    entry_point='gym.envs.mujoco:Grasper3DEnv_3obj',
    max_episode_steps=100
)
register(
    id='Grasper3d_wall-v0',
    entry_point='gym.envs.mujoco:Grasper3DEnvWall',
    max_episode_steps=100
)
register(
    id='Reacher3d_wall-v0',
    entry_point='gym.envs.mujoco:Reacher3DEnvWall',
    max_episode_steps=100
)
register(
    id='Grasper3d_move-v0',
    entry_point='gym.envs.mujoco:MovingGrasper3DEnv',
    max_episode_steps=100
)
# Atari
# ----------------------------------------
