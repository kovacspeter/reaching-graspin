...
add_task(
    ...
    group='mujoco',
    contributor='kovacspeter',
)

add_task(
    id='Grasper3d-v0',
    summary="Make a 3D robot arm grab object",
    group='mujoco',
    contributor='kovacspeter',
)

add_task(
    id='Grasper3d_3obj-v0',
    summary="Make a 3D robot arm grab object",
    group='mujoco',
    contributor='kovacspeter',
)
...
add_task(
    id='Grasper3d_wall-v0',
    summary="Make a 3D robot arm grasp object without wall colision",
    group='mujoco',
    contributor='kovacspeter',
)

add_task(
    id='Reacher3d_wall-v0',
    summary="Make a 3D robot arm reach object without wall colision",
    group='mujoco',
    contributor='kovacspeter',
)

add_task(
    id='Grasper3d_moving-v0',
    summary="Make movable 3D robot arm grasp object",
    group='mujoco',
    contributor='kovacspeter',
)
